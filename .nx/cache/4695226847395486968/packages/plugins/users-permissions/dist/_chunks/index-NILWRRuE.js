...
const indexYpe8E5LY = require("./index-Ype8E5LY-lG3F5mWr.js");
...
const index = require("./index-BeQMimiV.js");
...
const ProvidersPage = () => {
  ...
  const { trackUsage } = indexYpe8E5LY.useTracking();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(indexYpe8E5LY.Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(indexYpe8E5LY.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 3, rowCount: providers.length + 1, children: [
...
//# sourceMappingURL=index-NILWRRuE.js.map
