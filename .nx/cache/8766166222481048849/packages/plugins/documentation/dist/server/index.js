...
const documentation = {
  ...
  async index(ctx, next) {
    try {
      ...
      try {
        ...
        const layout = (await Promise.resolve().then(() => require("../_chunks/index-CYcTK1eg.js"))).default;
  ...
  async loginView(ctx, next) {
    ...
    try {
      const layout = (await Promise.resolve().then(() => require("../_chunks/login-EQSKn2h7.js"))).default;
