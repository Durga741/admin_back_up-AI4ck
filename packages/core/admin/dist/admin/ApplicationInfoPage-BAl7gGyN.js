...
const ApplicationInfoPage = () => {
  ...
  Theme.useAppInfo("ApplicationInfoPage", (state) => state.nodeVersion);
  Theme.useAppInfo("ApplicationInfoPage", (state) => state.shouldUpdateStrapi);
  Theme.useAppInfo("ApplicationInfoPage", (state) => state.strapiVersion);
  const AdminSeatInfo = useEnterprise.useEnterprise(
    AdminSeatInfoCE,
    async () => (await Promise.resolve().then(() => require('./AdminSeatInfo-BiRsi5oc.js'))).AdminSeatInfoEE
  );
  const {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(index.Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(Theme.Page.Main, { children: /* @__PURE__ */ jsxRuntime.jsxs("form", { onSubmit: handleSubmit, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(index.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 6, children: canRead && /* @__PURE__ */ jsxRuntime.jsxs(
        designSystem.Box,
        {
          hasRadius: true,
          background: "neutral0",
...
//# sourceMappingURL=ApplicationInfoPage-BAl7gGyN.js.map
