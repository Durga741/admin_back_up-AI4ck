...
import { b as Layouts } from './index-Ype8E5LY.mjs';
import { c as useTracking, r as useConfiguration, p as useAppInfo, k as useRBAC, P as Page } from './Theme-DQRUlj-X.mjs';
...
const ApplicationInfoPage = () => {
  ...
  useAppInfo("ApplicationInfoPage", (state) => state.nodeVersion);
  useAppInfo("ApplicationInfoPage", (state) => state.shouldUpdateStrapi);
  useAppInfo("ApplicationInfoPage", (state) => state.strapiVersion);
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import('./AdminSeatInfo-Dq608qZK.mjs')).AdminSeatInfoEE
  );
  const {
  ...
  return /* @__PURE__ */ jsxs(Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsx(Page.Main, { children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
      ...
      /* @__PURE__ */ jsx(Layouts.Content, { children: /* @__PURE__ */ jsx(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: canRead && /* @__PURE__ */ jsxs(
        Box,
        {
          hasRadius: true,
          background: "neutral0",
...
//# sourceMappingURL=ApplicationInfoPage-CKmTti1J.mjs.map
