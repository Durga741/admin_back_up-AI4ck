...
const PrivateRoute = require('./PrivateRoute-m4bg0tNv.js');
...
const GuidedTourStepper = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { alignItems: "stretch", children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { marginRight: 8, justifyContent: "center", minWidth: `3rem`, children: hasSectionBefore && /* @__PURE__ */ jsxRuntime.jsx(VerticalDivider, { state: STATES.IS_DONE, minHeight: `2.4rem` }) }),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { alignItems: "stretch", children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { marginRight: 8, direction: "column", justifyContent: "center", minWidth: `3rem`, children: hasSectionAfter && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        ...
        hasStepsBefore && /* @__PURE__ */ jsxRuntime.jsx(Number$1, { state: STATES.IS_ACTIVE, paddingTop: 3, children: nextSectionIndex + 1 })
      ] }) }),
    ...
    hasStepsBefore && hasSectionAfter && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 3, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { marginRight: 8, justifyContent: "center", width: `3rem`, children: /* @__PURE__ */ jsxRuntime.jsx(VerticalDivider, { state: STATES.IS_DONE, minHeight: `2.4rem` }) }) })
  ] });
};
...
const Onboarding = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Popover.Root, { onOpenChange: setIsOpen, children: [
    showHelpButton,
...
styledComponents.styled(designSystem.Button)`
  border-radius: 50%;
  padding: ${({ theme }) => theme.spaces[3]};
...
//# sourceMappingURL=AuthenticatedLayout-5Og7rb4f.js.map
