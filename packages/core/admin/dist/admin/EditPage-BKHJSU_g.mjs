...
import { b as useTypedSelector, P as Page, a as useNotification, e as useAPIErrorHandler } from './Theme-DQRUlj-X.mjs';
...
import { u as useField, w as useForm, x as MemoizedStringInput, F as Form, b as Layouts, B as BackButton, M as MemoizedInputRenderer } from './index-Ype8E5LY.mjs';
import { u as useEnterprise } from './useEnterprise-BGzVPL4w.mjs';
import { styled } from 'styled-components';
import { u as useWebhooks } from './useWebhooks-ChRqPd68.mjs';
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import('./EventsTable-DPTcVJ6K.mjs')).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-BKHJSU_g.mjs.map
