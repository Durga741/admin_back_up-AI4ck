...
const useWebhooks = require('./useWebhooks-CeQ6X5FT.js');
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require('./EventsTable-BT7zCtJk.js'))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-fFeMMTu1.js.map
